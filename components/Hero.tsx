      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          >
            ...
            {/* SEO-текст: скрыт визуально, но индексируется поисковиками */}
      <div className="sr-only">
        <h1>3D визуализация и архитектурная визуализация от студии Vizidiz</h1>
        <p>Заказать 3д рендер интерьера, экстерьера, предметов, рекламных кадров. 
           3д моделирование мебели, техники, упаковки на заказ. 
           Калькулятор стоимости 3д визуализации онлайн. 
           Работаем с архитекторами, дизайнерами, девелоперами, и частными предпринимателями по всей России: 
           Воронеж, Москва, Санкт-Петербург, Казань, Краснодар. 
           Срок выполнения от 3 дней. Работа по договору, предоплата.</p>
      </div>
    </section>
  );
};
